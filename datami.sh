               ...
               do
                 ...
                 'No such file')
                     ...
                     arq=$(grep android.conf -c <<< $(echo /data/user/0/$pacote/cache/*))
                       case $arq in
                            1)
                             ...
                             while :; do
                              net=$(ifconfig 2> /dev/null 2> /dev/null | egrep "wlan0|tun0" -o | tr -d ' \n')
                                case $net in
                                    wlan0)
                             ...
                             while :; do
                              net=$(ifconfig 2> /dev/null 2> /dev/null | egrep "rmnet" -o | tr -d ' \n')
                                case $net in
                                    rmnet) break;;
                               rmnetrmnet) break;;
                     ...
                     rmnetrmnetrmnetrmnet) break;;
                             ...
                             rm -rf /data/user/0/$pacote/cache/android.conf/*
